...
class Certs(models.Model):
    ...
    name = models.CharField(max_length=45, verbose_name=_("Name"), null=False)

    # 通用名称
    domain = models.CharField(max_length=128, verbose_name=_("Common Domain"), null=True)
    # 备用名称
    orther_domain = models.TextField(max_length=4096, null=True, verbose_name=_("Orther Domain"))
    ...
    issued_by = models.CharField(max_length=64, null=True, verbose_name=_('Issued By'))

    # 证书类型
    cert_type = models.CharField(max_length=4, null=True, blank=True, verbose_name=_("SSL Cert Type"))

    # 在线解析，还是离线解析
    method = models.BooleanField(default=0, choices=CERT_METHOD_CHOICES, verbose_name=_("Cert Detection Approach"))

    # 通过域名，在线解析
    domain_url = models.CharField(max_length=128, null=True, blank=True, verbose_name=_("Domain Url"))
